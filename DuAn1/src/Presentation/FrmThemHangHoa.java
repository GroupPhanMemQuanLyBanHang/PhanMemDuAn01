...
public class FrmThemHangHoa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnThemHangHoa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Upload.png"))); // NOI18N
    ...
    private void btnThemHangHoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemHangHoaActionPerformed
       ...
       int MaSanPham = Integer.parseInt(txtMaSSP.getText());
        int MaLoaiSP = Integer.parseInt(txtMLSP.getText());
        ...
        int soluong = Integer.parseInt(txtsoluong.getText());
         ...
         String GiaBan = txtGiaBan.getText();
          ...
          HangHoaSPDTO HH = new HangHoaSPDTO(0, MaSanPham, MaLoaiSP, TenSP, Email, HanBaoHanh, soluong, DoViTinh, GiaBan, GiaNhap, Mota);
